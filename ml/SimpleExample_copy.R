...
microbenchmark::microbenchmark(run_test(data), run_test_2(data), times = 1000)
...
for (i in 1:length(sample_size)){
  for (k in 1:kSim){
    data <- create_rct_data_2(n = sample_size[i], 1, mu_0=17, mu_1=18, sigma_0=2, sigma_1=2)
    test[k] <- run_test_2(data)
  }
